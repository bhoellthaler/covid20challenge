<template>
  <div id="app">
    <l-map :center="[-23.752961, -57.854357]" :zoom="6" style="height: 500px;" :options="mapOptions">
      <l-choropleth-layer :data="pyDepartmentsData" titleKey="department_name" idKey="department_id" :value="value" :extraValues="extraValues" geojsonIdKey="abbrev" :geojson="paraguayGeojson" :colorScale="colorScale">
        <template slot-scope="props">
          ...
          <l-slider title="Date Slider" position="bottomright"/>
        </template>
      </l-choropleth-layer>
    </l-map>
  </div>
...
<script>
import { InfoControl, ReferenceChart, ChoroplethLayer, Slider } from 'vue-choropleth'
